        ...
        <div className={cx(classes.wrapper, 'flex flex-col h-full')}>
            <div className={cx(classes.logo, 'text-white m-6')}>
                <Link href="/" passHref>
                    <a>
                        {!isCollapsed ? (
                            <Image alt="Spotify" title="Spotify" width={72} height={59} className="invert h-full" src="/assets/logo.png" />
                        ) : (
                            <Image alt="Spotify" title="Spotify" width={36} height={39} className="invert h-full" src="/assets/logo.png" />
                        )}
                    </a>
                </Link>
            </div>
